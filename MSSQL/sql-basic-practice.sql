...
SELECT TOP 20 PERCENT NationalIDNumber , JobTitle , BirthDate  FROM 
HumanResources.Employee

--------------------------------------------------------------------


--4) Retrieve	the	top	500	rows	from	the	
--HumanResources.Employee	table.		Return	the	
--NationalIDNumber,	JobTitle	and	BirthDate	columns.		
--Give	the	NationalIDNumber	
--column	an	alias,	“SSN”,	and	the	JobTitle	column	an	alias,	
--“Job	Title”.

SELECT TOP 500  NationalIDNumber AS [SSN], 
JobTitle AS [Job Title], BirthDate 
FROM HumanResources.Employee

---------------------------------------------------------------
--5) Return	all	rows	and	all	columns	from	
--the	Sales.SalesOrderHeader	table.

SELECT * FROM Sales.SalesOrderHeader
--------------------------------------------------------------------

--6) Return	the	top	50	percent	of	rows	and	all	
--columns	from	the	Sales.Customer	table.

SELECT TOP 50 PERCENT * FROM Sales.Customer

--------------------------------------------------------------------

--7) Return	the	Name	column	from the 
--Production.vProductAndDescription view.		Give	
...
----------------------------------------------------------------
--9) Return	all	rows	and	columns	from	the	table	named
--Production.BillOfMaterials

SELECT * FROM Production.BillOfMaterials

-----------------------------------------------------------------
--10) Return	the	top	1500 rows	and	columns	from	
--the	view	named	
